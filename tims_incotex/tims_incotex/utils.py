...
def get_tims_settings(company):
    """Fetch TIMS Incotex Settings from the doctype. If not found, return None."""
    try:
        settings = frappe.get_doc("Tims Incotex Settings", {"company": company})
    ...
    return {
        ...
        "sign_on_submit": settings.sign_on_submit,
